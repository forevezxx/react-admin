export default {
    menus: [ // 菜单相关路由
        { 
            key: '/app/dashboard/shouldPay', title: '应付管理', icon: 'mobile', component: 'Dashboard',
            subs: [
                { key: '/app/ui/document', title: '供应商档案', component: 'Dashboard' },
                { key: '/app/ui/pay', title: '应付录入', component: 'Buttons' },
            ]
        },
        {
            key: '/app/dashboard/shouldCollect', title: '应收管理', icon: 'mobile',
            subs: [
                { key: '/app/ui/buttons', title: '客户档案', component: 'Dashboard' },
                { key: '/app/ui/buttons', title: '应收录入', component: 'Dashboard' },
            ]
        },
        {
            key: '/app/dashboard/pay', title: '出纳管理', icon: 'mobile',
            subs: [
                { key: '/app/ui/buttons', title: '备用金管理', component: 'Dashboard' },
                { key: '/app/ui/buttons', title: '报销管理', component: 'Dashboard' },
                { key: '/app/ui/buttons', title: '公费管理', component: 'Dashboard' },
            ]
        },
        {
            key: '/app/dashboard/data', title: '数据管理', icon: 'mobile',
            subs: [
                { key: '/app/ui/buttons', title: '销售数据', component: 'Dashboard' },
                { key: '/app/ui/buttons', title: '客户数据', component: 'Dashboard' },
                { key: '/app/ui/buttons', title: '采购数据', component: 'Dashboard' },
            ]
        },
        {
            key: '/app/dashboard/checkIn', title: '考勤管理', icon: 'mobile',
            subs: [
                { key: '/app/ui/buttons', title: '考勤记录', component: 'Dashboard' },
                { key: '/app/ui/buttons', title: '班次管理', component: 'Dashboard' },
            ]
        },
        {
            key: '/app/dashboard/account', title: '账户管理', icon: 'mobile',
            subs: [
                { key: '/app/ui/buttons', title: '用户管理', component: 'Dashboard' },
            ]
        },
        ...
        // {
        //     key: '/app/ui', title: '应收管理', icon: 'scan',
        //     subs: [
